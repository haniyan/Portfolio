...
const currentWindow2 = document.querySelector(".view-two")
...
const backFife = document.querySelector(".back-fife");
const backSix = document.querySelector(".back-six");
const backSeven = document.querySelector(".back-seven");


const me = document.createElement("div");
me.classList.add(".thatsMe");
currentWindow1.appendChild(me);
currentWindow2.appendChild(me);
